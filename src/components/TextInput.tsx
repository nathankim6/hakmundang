    ...
    <div className="space-y-1">
      <div className="relative group">
        ...
        <Textarea
          ...
          className="h-[80px] w-full bg-secondary/50 border-2 border-primary/20 focus:border-primary transition-all duration-300 rounded-lg text-foreground placeholder:text-muted-foreground resize-none relative backdrop-blur-sm text-sm"
        />
      </div>
    </div>
  );
