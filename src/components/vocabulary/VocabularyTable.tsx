            ...
            return (
              <React.Fragment key={index}>
                {showQuestionHeader && entry.questionNumber && (
                  <tr>
                    <td colSpan={6} className="bg-[#F1F0FB] p-3 font-semibold text-[#1A1F2C]">
                    ...
                    return (
                      <td key={cellIndex} className="p-3 border border-[#D6BCFA]/30">
                        <Input
                          ...
                          className="bg-transparent border-none hover:bg-white focus:bg-white font-gulim"
                        />
                      </td>
                    );
                  })}
