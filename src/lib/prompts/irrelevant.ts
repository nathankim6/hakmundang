...
{지문의 모든 문장을 그대로 작성한 후, 지문의 주제와 일정 부분 관련은 있으나 흐름 상 관련 없는 1개의 새로운 문장을 만들어 아무 위치에 삽입합니다. 이후 첫 문장을 제외한 나머지 문장 중 5개를 선택해 순서대로 각 문장의 앞에 ①, ②, ③, ④, ⑤ 번호를 붙입니다. 단, ⑤번은 반드시 지문의 마지막 문장 바로 앞에 위치해야 합니다. 새로 삽입된 문장의 번호는 무작위로 정해집니다.}
