...
{지문의 모든 문장을 그대로 작성한 후, 첫 문장을 제외한 문장들의 앞에 순서대로  ①, ②, ③, ④, ⑤ 번호를 붙입니다.  번호를 부여할 때는 중간에 뛰어 넘는 문장이 있어도 괜찮으며, 최대한 분산하여 배치합니다. 이후 지문의 주제와 일정 부분 관련은 있으나 흐름 상 관련 없는 1개의 새로운 문장을 만들어 특정 번호 뒤에 배치하여 정답을 만듭니다. 새로운 문장(정답)의 위치는 무작위로 배치합니다.}
