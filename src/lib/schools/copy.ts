...
export const SECTION = {
  ...
  achieve: {
    ...
    empty: {
      ...
      text: "이 항목은 학교알리미가 사람만 보게 막아 둔 화면이라 프로그램이 대신 받아 오지 못해요. 학교마다 엑셀 세 개를 받아 '학교 기록' 탭에 놓으면 이 자리가 채워집니다.",
      steps: [
        "'학교 기록' 탭 체크리스트에서 '학교알리미 열기'를 눌러요. 학교 페이지가 바로 열립니다.",
        "공시정보에서 '4-나. 교과별 학업성취 사항'을 열고 보안문자를 입력해요.",
        "오른쪽 위 '엑셀다운로드'를 받고, 공시연도를 2025·2024로 바꿔 두 번 더 받아요.",
        "받은 파일을 체크리스트 아래 상자에 한 번에 끌어다 놓으면 끝이에요.",
      ],
    },
...
export const ACHIEVE_IMPORT = {
  ...
  checklist: {
    title: "받을 파일 체크리스트",
    lede: "이 화면은 학교알리미가 보안문자로 막아 둬서 프로그램이 대신 받지 못해요. 대신 학교마다 세 번 클릭이면 끝나게 길을 냈습니다.",
    steps: [
      "'학교알리미 열기'를 누르면 그 학교 페이지가 새 탭으로 열려요.",
      "공시정보에서 '4-나. 교과별 학업성취 사항'을 열고 보안문자를 입력해요.",
      "오른쪽 위 '엑셀다운로드'. 공시연도를 2025, 2024로 바꿔 두 번 더 받아요.",
      "받은 파일을 아래 상자에 한 번에 끌어다 놓으면 학교와 연도는 알아서 맞춰져요.",
    ],
    open: "학교알리미 열기",
    noLink: "학교알리미 주소를 아직 몰라요. 사이트에서 학교명으로 검색해 주세요.",
    progress: (have: number, total: number) => `${have} / ${total} 파일`,
    done: "전부 받았어요",
    noneSelected: "먼저 '학교 고르기'에서 학교를 담으면 여기 학교별로 정리돼요.",
