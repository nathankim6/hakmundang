...
/* ── 패러프레이즈 ── */
table.para{width:100%;border-collapse:collapse;font-size:8.5pt}
...
table.para td{padding:17px 10px 17px 0;border-bottom:1px dotted var(--hair);vertical-align:top;line-height:1.45}
...
table.para td.dst u{text-decoration:none;border-bottom:1.6px solid var(--ac);padding:0 18px;margin:0 3px}
/* ── Check Up ── */
