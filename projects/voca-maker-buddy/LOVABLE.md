...
| 항목 | 값 |
|---|---|
| Lovable 편집기 | https://lovable.dev/projects/1a478a96-5e7a-4930-b885-3510e820d219 |
| 배포 주소 | (미배포) |
| Lovable 마지막 수정 | 2025-08-16 |
| 데이터베이스 | 없음 |
| 파일 | 텍스트 78개 복사, 그림·미디어 1개 내려받음 |
...
- `public/placeholder.svg` ← projects/block-vocab-mastery-web/
