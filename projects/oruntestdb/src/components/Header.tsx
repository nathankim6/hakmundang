        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4 cursor-pointer group" onClick={() => navigate("/")}>
            ...
            <div className="space-y-2">
              <h1 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-white via-white to-white/80 bg-clip-text text-transparent drop-shadow-lg font-display">옳은영어 고등학교 내신 대표문항&amp;서답형 DB</h1>
              <p className="text-sm text-white/95 font-semibold tracking-wide">Orun English High School Signature&amp;Narrative Questions Database</p>
            </div>
          </div>
