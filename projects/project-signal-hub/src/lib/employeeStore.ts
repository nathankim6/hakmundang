...
import { mockEmployees } from './employee/mockData';
...
// Re-export from employee module
export * from './employee';

// Create a local store for immediate access without async loading
// This helps us avoid the lag during initial page load
export const useEmployeeStore = create<{
  ...
  employees: mockEmployees, // Initialize with mock data for instant access
  isLoading: false,
  error: null,
  ...
  getEmployeesByDepartment: (department: EmployeeDepartment) => {
