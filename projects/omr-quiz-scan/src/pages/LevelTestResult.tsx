...
import { prepAnalysisCategories, prepSectionNames } from '@/data/prepLevelTestQuestions';
...
const LevelTestResult = () => {
  ...
  const getMaxScore = () => {
    switch (testType) {
      case 'prep': return getPrepSet(detectPrepVersion(result?.answers || {})).totalMaxScore;
          ...
          <div className="relative z-10 p-4 sm:p-5">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-slate-300 text-[10px] sm:text-xs mt-0.5">Orun English Level\u00a0 Assessment\u00a0 Report</p>
              </div>
            </div>
