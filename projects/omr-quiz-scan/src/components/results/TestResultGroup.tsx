        ...
        <div className="px-5 py-4 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5 shrink-0" onClick={(e) => e.stopPropagation()}>
            <Button
              variant="ghost"
              size="sm"
              className="h-8 px-2.5 text-xs text-slate-500 hover:text-emerald-700 hover:bg-emerald-50"
            ...
            <Button
              variant="ghost"
              size="sm"
              className="h-8 px-2.5 text-xs text-slate-500 hover:text-violet-700 hover:bg-violet-50"
