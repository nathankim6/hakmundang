    ...
    <div className="bg-white">
      <div className="max-w-6xl mx-auto p-2 sm:p-4 md:p-6 space-y-2 sm:space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-3 sm:mb-4">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="min-w-0">
                  <h1 className="font-bold text-sm sm:text-xl text-white tracking-tight leading-tight">옳은영어 영작 테스트 리포트</h1>
        ...
        <div className="pt-2 pb-1 text-center">
          <p className="text-[10px] text-black">© {new Date().getFullYear()} ORUN ENGLISH. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
