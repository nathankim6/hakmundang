  ...
  return (
    <div className="w-80 flex-shrink-0">
      <div className="sticky top-8 z-50">
        <div className="bg-gradient-to-br from-gray-100 via-[#F5F5F7] to-[#EAEAEC] shadow-lg border border-gray-200/40 backdrop-blur-sm p-4 rounded-lg relative overflow-hidden group fixed w-[320px]">
          ...
          {/* Veritas-themed decorative icons */}
