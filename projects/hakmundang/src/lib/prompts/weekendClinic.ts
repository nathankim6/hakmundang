...
[동사 워크북]
Water (1 have) → ____________ unique properties that (2 make) → ____________ it essential for life. It can (3 absorb) → ____________ large amounts of heat, which (4 help) → ____________ regulate temperature on Earth. Many organisms (5 be) → ____________ by water's special characteristics. Water (6 exist) → ____________ in three states. When water (7 freeze) → ____________, it (8 expand) → ____________ and (9 become) → ____________ less dense, (10 allow) → ____________ ice (11 float) → ____________ on liquid water. This property (12 protect) → ____________ aquatic life during winter by (13 create) → ____________ an insulating layer of ice.
...
6. 빈칸은 모두 12개의 언더바(_)로 통일하여 표시하세요.
