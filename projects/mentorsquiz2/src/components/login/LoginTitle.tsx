...
export const LoginTitle = () => {
  return <div className="space-y-2 text-center">
      <h1 className="text-3xl font-medium animate-title relative group transition-all duration-300 whitespace-nowrap">
        <span className="inline-block transform hover:scale-105 transition-transform duration-300 relative text-[#E5E7EB] drop-shadow-[0_2px_2px_rgba(0,0,0,0.5)] text-xl">
          MENTORS TABLE AI QUIZ MAKER
