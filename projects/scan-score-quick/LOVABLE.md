...
| 항목 | 값 |
|---|---|
| Lovable 편집기 | https://lovable.dev/projects/e9d26bbc-1c92-445b-8bdb-c9e85bc08a91 |
...
- `src/assets/exam-icon.png` (코드에서 사용)
- `src/assets/level-chart-icon.png`
- `src/assets/level-test-result-logo.png` (코드에서 사용)
- `src/assets/orun-academy-logo-level-test.jpg`
