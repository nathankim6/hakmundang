        ...
        <div className="max-w-lg mx-auto">
          <Card className="p-6 shadow-xl border-0 bg-white/80 backdrop-blur">
            <div className="text-center mb-6">
              ...
              />
              <h1 className="text-2xl font-bold mb-2 elegant-shimmer-text">Brainiac English Assessment Test (BEAT)</h1>
              <p className="text-slate-600 text-sm">브래니악 영어 진단평가 고등부 · BEAT</p>
            </div>
