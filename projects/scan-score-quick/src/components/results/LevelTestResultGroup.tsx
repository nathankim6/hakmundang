...
const LevelTestResultGroup = ({
  ...
  const handleDownloadImage = async (result: LevelTestResult) => {
    ...
    try {
      ...
      link.href = url;
      const fileName = `${result.student_school || ''}${result.student_grade || ''}_${result.student_name}_BEAT_결과.jpg`;
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            {result.student_name} 학생의 BEAT 결과를 삭제하시겠습니까?
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                      ...
                      <div className="relative z-10 p-3">
                        ...
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <h1 className="font-bold text-base text-white tracking-tight">브래니악 영어 진단평가(BEAT) · 중등부 리포트</h1>
                          ...
                          <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-white/10 border border-white/20">
                            ...
                            <span className="text-[10px] font-semibold text-white">  BEAT · Middle</span>
                          </div>
                        </div>
