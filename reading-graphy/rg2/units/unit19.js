...
K.push(T([W], [new TableRow({ children: [cel([
  ...
  p([t("STEP 3 ", { size: 19, bold: true, color: NAVY2 }), t("3-3 (c) → (e) → (a) → (d) → (b)  ·  Newtok became one of the first villages to move because of climate change.", { size: 19, bold: true })], { after: 25 }),
