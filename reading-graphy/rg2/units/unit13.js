...
K.push(T([W], [new TableRow({ children: [cel([
  ...
  p([t("STEP 3 ", { size: 19, bold: true, color: NAVY2 }), t("3-3 ⓒ → ⓐ → ⓑ → ⓓ  ·  Puffins were once an endangered species, but now there are more puffins than before.", { size: 19, bold: true })], { after: 25 }),
