...
K.push(sp(65));
["① Kohl: Ancient Egypt’s Makeup for Healthy Eyes", "② How to Draw Thick Black Lines",
 "③ Zinc Oxide: A Powerful Sunblock Today", "④ The Weather of the Egyptian Desert",
...
["① 사막에 모래바람이 부는 이유", "② 요즘 유행하는 아이라이너 그리는 법", "③ 고대 이집트의 눈 화장 '콜'과 그 목적"].forEach(c =>
...
B("1 T — 문장 1.   2 F — 문장 3: 여자만이 아니라 남자와 여자 둘 다(Both men and women)다.   3 T — 문장 3.   4 T — 문장 5.   5 F — 문장 6: 밝은 달이 아니라 밝은 해(sun)다.   6 T — 문장 9.   7 F — 문장 10: 약한 게 아니라 강력한(powerful) 자외선 차단제다.   8 F — 문장 12: 세균을 강하게 하는 게 아니라 물리치도록(fight) 돕는다.  거짓 문장은 모두 본문에서 딱 한 요소(only women, moon, weak, stronger)를 비튼 것이다.", true);
Hs("R2   사건 순서   ·   (b) → (c) → (a) → (d)");
