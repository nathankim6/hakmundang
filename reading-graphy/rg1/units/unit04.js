...
K.push(T([W], [new TableRow({ children: [cel([
  ...
  p([t("STEP 3 ", { size: 19, bold: true, color: NAVY2 }), t("3-3 (b) → (d) → (a) → (c)  ·  Blue feet are a sign of good health and are attractive to the female.", { size: 19, bold: true })], { after: 25 }),
