...
K.push(T([W], [new TableRow({ children: [cel([
  ...
  p([t("STEP 3 ", { size: 19, bold: true, color: NAVY2 }), t("3-3 ⓑ → ⓐ → ⓒ → ⓓ  ·  With new spacesuits, astronauts can move more easily and study the Moon better.", { size: 19, bold: true })], { after: 25 }),
