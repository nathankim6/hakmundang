...
/* 먼저 보기 — 다 표시된 문장 2을 먼저 구경하세요. 라벨은 단어 ", { size: 15, color: SUB }),
...
K.push(T([W], [new TableRow({ children: [cel([
  ...
  p([t("STEP 3 ", { size: 19, bold: true, color: NAVY2 }), t("3-3 ⓒ → ⓐ → ⓓ → ⓑ  ·  The moss balls move together across the ice, and it is still a mystery.", { size: 19, bold: true })], { after: 25 }),
