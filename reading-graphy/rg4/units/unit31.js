...
K.push(T(aw, [
  ...
  ...(() => {
    ...
    const chips8 = () => T([820, 1200, 170, 1200, 300, 930, 1200, 170, 1200], [new TableRow({ children: [
      labC("it =", 820), chipC("보내는 물건", 1200), gapC(170), chipC("감자 녹말", 1200), gapC(300),
      labC("there =", 930), chipC("우주", 1200), gapC(170), chipC("지구", 1200),
    ] })]);
    return [
...
K.push(T([W], [new TableRow({ children: [cel([
  ...
  p([t("STEP 3 ", { size: 19, bold: true, color: NAVY2 }), t("3-3 ⓑ → ⓓ → ⓐ → ⓒ  ·  StarCrete is a strong and light concrete made from potato starch for space missions.", { size: 19, bold: true })], { after: 25 }),
