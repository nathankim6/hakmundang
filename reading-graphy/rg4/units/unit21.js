...
K.push(sp(65));
["① The Windcatcher: Iran’s Cooling Tower Without Electricity", "② How to Build a Chimney for Your Kitchen",
 "③ The Hottest Desert Cities in the World", "④ Ancient Egyptian Art and Its Bright Colors",
...
["① 야구에서 포수(catcher)가 맡은 역할", "② 전기 없이 집을 시원하게 하는 이란의 장치", "③ 3,000년 전 고대 이집트 미술 이야기"].forEach(c =>
...
K.push(T(tfw, [
  ...
  ...[
    ...
    "A windcatcher needs a lot of electricity to work.",
    "A windcatcher is located on the roof or the tallest part of the house.",
...
B("1 T — 문장 2.   2 F — 문장 2: 전기가 필요 없는(electricity-free) 장치다.   3 T — 문장 5.   4 F — 문장 6: short(낮은)가 아니라 tall(높은) 굴뚝처럼 생겼다.   5 T — 문장 7.   6 F — 문장 9: 20–30°C가 아니라 8–12°C다.   7 T — 문장 10.   8 F — 문장 10: 중국(Chinese)이 아니라 이집트(Egyptian) 미술이다.", true);
Hs("R2   사건 순서   ·   (b) → (d) → (c) → (a)");
